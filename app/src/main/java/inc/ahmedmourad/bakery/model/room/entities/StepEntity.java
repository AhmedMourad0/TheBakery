...
public class StepEntity {
	...
	public StepEntity(final int id, final int recipeId, final int stepId, final String shortDescription, final String description, final String videoUrl, final String thumbnailUrl) {
		this.id = id;
